    ...
    <div className="min-h-screen flex bg-slate-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-brand-primary overflow-hidden justify-center items-center text-left">
        <div
          ...
          style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1524178232363-1fb2b075b655?auto=format&fit=crop&w=1000&q=80)' }}
        />
        ...
        <div className="relative z-20 max-w-lg px-12 space-y-6 text-white">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold leading-tight">
            Accelerate your professional <span className="text-brand-secondary">journey today</span>.
          </h2>
          <p className="text-slate-200 leading-relaxed text-sm lg:text-base">
            Create an account to gain instant access to interactive courses, track assignment submissions, and review custom evaluations directly.
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    type="text"
                    placeholder="https://images.com/user.png"
                    value={photoUrl}
